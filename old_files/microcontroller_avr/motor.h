...
#include <stdlib.h>
extern "C" {
#include "digio.h"  // in this file there may be smth. that is needed in a file .c
}

class Motor {
public:
    // ctor
    Motor(uint8_t bit_rege_dira_, uint8_t bit_rege_dirb_, float kp_, float ki_, float kd_); // constructor
