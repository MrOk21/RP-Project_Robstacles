...
#ifdef __cplusplus
extern "C" {                    // whatever is inside it has been generated in C, it will be compiled with a c compiler
#endif // if I am compiling with a c compiler, the prepocessor will read the extern C
