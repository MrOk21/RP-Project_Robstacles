 ...
 */
  void PWM_init(void); // we tell the arduino to set up all the pins for pwm  signal 
 ...
 */
  void PWM_setDutyCycle(uint8_t value); // we decide the pwm duty cycle percentage
